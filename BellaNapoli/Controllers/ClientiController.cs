...
namespace BellaNapoli.Controllers
{
    public class ClientiController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdClienti,Nome,Cognome,Indirizzo")] Clienti clienti)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdClienti,Nome,Cognome,Indirizzo")] Clienti clienti)
        {
            if (ModelState.IsValid)
            {
